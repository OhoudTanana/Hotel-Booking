...
//status will detect if the hotel is actaully available and valid or not
//if we change the status in the database, !1, the new field wont be displayed
//hotels
$hotels = $conn->query("SELECT * FROM hotels WHERE status = 1");

$hotels->execute();

$allHotels = $hotels->fetchALL(PDO::FETCH_OBJ); //will bring the data from this hotel table
...
?>
    ...
    <section class="ftco-section ftco-services">
    	<div class="container">
			...
			<?php foreach($allHotels as $hotels) : //looping through this array, then grab it as an object, by fetch ?>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(<?php echo HOTELSIMAGES; ?>/<?php echo $hotels->image; ?>);"> </div>
              <div class="media-body py-4 px-3">
                <h3 class="heading"><?php echo $hotels->name; ?></h3>
                <p><?php echo $hotels->description; ?></p>
                <p>Location: <?php echo $hotels->location; ?>.</p>
				<?php
				//check if the user is logged in to display the vire room button for available room in every hotel
				if(isset($_SESSION['id'])){
					echo '<p><a href="rooms.php?id= ' . $hotels->id .'  " class="btn btn-primary">View rooms</a></p>'; 
				
				} else{
					echo '<p><a href="auth/login.php  " class="btn btn-primary">View rooms</a></p>';
				}
				?>
            ...
            <h2>Apartment Room</h2>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a  class="img" style="background-image: url(<?php echo ROOMSIMAGES; ?>/<?php echo $rooms->image; ?>);"></a>
