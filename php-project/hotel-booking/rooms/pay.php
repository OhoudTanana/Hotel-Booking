        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
              ...
              <div class="container">  
                    ...
                    <script src="https://www.paypal.com/sdk/js?client-id=AeZ-vETYCi7FTdEWiw-OWaOXlN5HXldhVwgZeQRBqQCiP5wmB0YNHkJtB1UeK_D0_6bPmmMMkVb2csYt&currency=USD"></script>
                    ...
                    <script>
                        ...
                        onApprove: (data, actions) => {
                            return actions.order.capture().then(function(orderData) {
                             ...
                             window.location.href='http://localhost/php-project/hotel-booking';
                            });
                        }
